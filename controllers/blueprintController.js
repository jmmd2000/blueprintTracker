...
exports.bp_create_post = [
    ...
    body('bp_name', 'Name must not be empty.').trim().isLength({
        min: 1
    }).escape(),
...
exports.bp_update_get = function (req, res, next) {
    ...
    async.parallel({
        ...
        function (err, results) {
            ...
            for (var all_a_iter = 0; all_a_iter < results.bp.attachments.length; all_a_iter++) {
                for (var bp_a_iter = 0; bp_a_iter < results.bp.attachments.length; bp_a_iter++) {
                    if (results.bp.attachments[all_a_iter]._id.toString() === results.bp.attachments[bp_a_iter]._id.toString()) {
...
exports.bp_update_post = [
    ...
    (req, res, next) => {
        ...
        var bp = new Blueprint({
            ...
            weaponBase: req.body.bp_base,
            weaponClass: req.body.bp_wc,
            attachments: (typeof req.body.attachments === 'undefined') ? [] : req.body.attachments,
            _id: req.params.id
        });
